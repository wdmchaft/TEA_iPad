...
#import "DWDrawingItemOval.h"


@implementation DWDrawingItemOval
...
-(void)drawIntoContext:(CGContextRef)pContext
{
    if([points count]==2)
    {
        ...
        CGContextAddEllipseInRect(pContext,CGRectMake( startPos.x, startPos.y, lastPos.x - startPos.x , lastPos.y - startPos.y)); 
