...
#import "DWDrawingItemLibraryItem.h"
...
@implementation DWDrawingItemLibraryItem
@synthesize text;
...
- (void) displayLibraryItem
{
    ...
    textField.text = @"Learn Why You'll Love to Develop with Apple Technologies Read about our powerful, yet easy to use tools and technologies that allow you to turn your concepts into reality";
...
{
    DWDrawingItemLibraryItem *itemRect = [[[DWDrawingItemLibraryItem alloc] init]autorelease];
