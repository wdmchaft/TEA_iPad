...
- (void)layoutSubviews
{
    ...
    for (UIView *sub in [self subviews])
	{
        ...
        else if([sub class] == [UILabel class])
		{
			[(UILabel*) sub setTextColor:borderColor];
		}
        else if([sub class] == NSClassFromString(@"UIAlertButton")) 
        {
            [(UIButton*) sub setTitleColor:borderColor forState:UIControlStateNormal];
        }
	}
}
